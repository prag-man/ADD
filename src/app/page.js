    ...
    <div className="flex text-center items-center flex-col overflow-x-hidden scroll-none">
      <div className="w-full flex flex-col-reverse md:flex-row items-center justify-between py-10">
        <div className="flex-1 flex flex-col text-center md:text-left md:ml-20 md:py-14 py-7 items-center md:items-start px-7 md:px-0">
          <h1 className="text-2xl md:text-3xl font-bold text-[#664228] mb-4">
            Anuvrat Digital Detox
          </h1>
          <p className="text-[#999999] w-[90%]">
            Small (anu), Vows(vrat) towards Digital Detox. Digital detoxing
            means taking a break from using an electronic device or being online
            for a scheduled amount of time. Stepping away from technology allows
            you to be more present with yourself & your loved ones. It may also
            relieve stress, improve sleep, and deepen your relationship with
            family & friends.
          </p>
          <Link href="/register">
            <button className="rounded-3xl px-4 py-2 text-base md:text-lg font-medium bg-[#664228] w-fit text-white mt-10">
              Take a Pledge
            </button>
          </Link>
        </div>
        ...
        <div className="flex-1 relative md:h-[450px] h-[100px] w-full hidden overflow-clip no-scrollbar mr-16 md:block">
          ...
          <div className="ellipse h-[500px] mt-[242px] w-full rounded-[50%] bg-gradient-to-b from-[#66422880] via-white to-white absolute">
            <div className="h-full w-full bg-white mt-1 rounded-[50%] flex justify-center">
              <h1 className="mt-[10%] text-2xl text-[#664228] font-bold">
                Anuvrat Vishva Bharati Society
              </h1>
            </div>
          </div>
        </div>
        <div className="flex-1 w-full relative overflow-clip no-scrollbar block md:hidden justify-center items-center">
          ...
          <div className="relative h-[55px] -mt-[26%] mx-auto">
            <h1 className=" text-lg text-[#664228] font-bold">
              Anuvrat Vishva Bharati Society
            </h1>
      ...
      <p className="text-xl m-4">
        Want to volunteer for the cause?{" "}
        <a
          href="https://forms.gle/8RF38tWyPF4aMJ1y8"
          className="text-[#664228] underline"
          target="blank"
        >
          Click here
        </a>
      ...
      <div className="px-7 md:px-20 mt-5 w-full">
        <h1 className="text-xl md:text-2xl font-bold">
          Anuvrat Digital Detox Benefits
        </h1>
        <p className="text-[#00000073] font-medium text-lg md:text-xl mt-1">
          When you step away from your devices and focus on the real world
        </p>
      ...
      <div className="flex flex-col w-full items-center bg gap-8">
        <h1 className="md:text-2xl text-xl font-bold text-[#664228] bg-[#F0DFCD] w-full pt-7 pb-14 -mb-16">
          Want to be Yearly DIGICHAMP?
        </h1>
        <Tabs />
        <Vision />
        <Gallery />
